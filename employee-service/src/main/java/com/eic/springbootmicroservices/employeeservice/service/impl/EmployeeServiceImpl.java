...
import com.eic.springbootmicroservices.employeeservice.exception.EmployeeAlreadyExistsException;
import com.eic.springbootmicroservices.employeeservice.exception.ResourceNotFoundException;
...
//	private RestTemplate restTemplate;
	...
	public EmployeeDto saveEmployee(EmployeeDto employeeDto) {
		...
		if(optionalEmployee.isPresent()) {
			throw new EmployeeAlreadyExistsException("Employee already exists with email id: "+employeeDto.getEmail());
		}
...
//		DepartmentDto departmentDto = responseEntity.getBody();
	...
	public EmployeeDto updateEmployee(EmployeeDto employeeDto) {
		...
		if (!optionalEmployee.isPresent()) {
			throw new ResourceNotFoundException("Employee", "EmployeeId", employeeDto.getId());
		}
