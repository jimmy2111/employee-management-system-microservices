...
class EmployeeServiceImplTest {
	...
	void testGetEmployeeById() {
	    ...
	    ApiResponseDto result = employeeServiceImpl.getEmployeeById(1L);
	    assertEquals(departmentDto.getDepartmentCode(), apiResponseDto.getDepartment().getDepartmentCode());
	...
	void testGetDefaultDepartment() {
		...
		ApiResponseDto result = employeeServiceImpl.getDefaultDepartment(1L);
	...
	void testGetAllEmployeesByPagingAndSorting() {
		...
		Page<ApiResponseDto> result = employeeServiceImpl.getAllEmployeesByPagingAndSorting(0, 3, "firstName", "asc");
